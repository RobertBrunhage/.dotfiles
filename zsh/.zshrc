...
export FZF_DEFAULT_OPTS=$FZF_DEFAULT_OPTS' --color=bg+:#272638,hl+:#5fd7ff --color=info:#afaf87,prompt:#d7005f,pointer:#d7005f --color=marker:#87ff00,spinner:#d7005f,header:#87afaf'
